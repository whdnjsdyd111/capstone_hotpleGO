...
$(function (){
    ...
    var innerRainHolder = [weatherContainer1.group(), weatherContainer2.group(), weatherContainer3.group()];
...
// 🏃 start animations
    ...
    function makeRain()
    {
        ...
        var line = innerRainHolder[(2 - Math.floor(lineWidth))].path('M0,0 0,' + lineLength).attr({
            fill: 'none',
